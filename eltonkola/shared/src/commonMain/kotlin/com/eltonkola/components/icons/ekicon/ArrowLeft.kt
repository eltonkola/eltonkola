...
public val EKIcon.ArrowLeft: ImageVector
    get() {
        if (_arrowLeft != null) {
            return _arrowLeft!!
        }
        _arrowLeft = Builder(name = "ArrowLeft", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF2A353D)),
                ...
                moveTo(15.0f, 6.0f)
                lineTo(9.7071f, 11.2929f)
                curveTo(9.3738f, 11.6262f, 9.2071f, 11.7929f, 9.2071f, 12.0f)
                curveTo(9.2071f, 12.2071f, 9.3738f, 12.3738f, 9.7071f, 12.7071f)
                lineTo(15.0f, 18.0f)
            }
        }
        .build()

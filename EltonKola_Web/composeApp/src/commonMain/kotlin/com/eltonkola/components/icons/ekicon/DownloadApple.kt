...
public val EKIcon.DownloadApple: ImageVector
    get() {
        if (_downloadApple != null) {
            return _downloadApple!!
        }
        _downloadApple = Builder(name = "DownloadApple", defaultWidth = 24.0.dp, defaultHeight =
                24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF555555)), stroke = null, strokeLineWidth = 0.0f,
...
private var _downloadApple: ImageVector? = null

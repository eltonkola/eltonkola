...
fun defaultScrollbarStyle() = ScrollbarStyle(
	...
	unhoverColor = EKTheme.colors().secondary,
	hoverColor = EKTheme.colors().primary
)
...
internal suspend fun PointerInputScope.detectTapAndPress(
	...
	val pressScope = PressGestureScopeImpl(this@detectTapAndPress)
	...
	awaitEachGesture {
		...
		if (onPress !== NoPressGesture) {
			// We now have a proper CoroutineScope to launch from
			launch {

...
import eltonkola.composeapp.generated.resources.img_portfolio
...
fun Portfolio() {
    Row(
        ...
        Column(
            modifier = Modifier.fillMaxHeight().weight(0.6f).padding(26.dp).verticalScroll(rememberScrollState())
        ){
        ...
        Box(
            ...
            EkCard(Modifier) {
                Image(
                    painter = painterResource(Res.drawable.img_portfolio),
